...
import { CarouselMovieProps } from "./CaroselMovie.types";
import { Card, CardContent } from "@/components/ui/card";
import Image from "next/image";
import { ActionsButtons } from "./ActionsButtons/ActionsButtons";
import { ChaptersInfo } from "./Chanptersinfo";
import { FilmGenres } from "./FilmGenres";


export  function CaroselMovie(props: CarouselMovieProps) {
      ...
      >
        <Card  className="cursor-pointer  transition  delay-300  group relative">
          <CardContent className="flex  aspect-video  items-center  justify-center  p-6 relative border-none rounded-md bg-zinc-900">
            ...
            <Image src = {movie.thumbnailUrl} alt= "Image"  fill sizes="(max-width: 768px) 100vw , 50vw"  className="rounded-md"
            />
            <div  className="opacity-0 absolute top-0  translate-all duration-300 z-10 invisible sm:visible  delay-300
