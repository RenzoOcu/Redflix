...
export function SelectorProfile(props: SelectorProfileProps) {
    ...
    const { changeCurrentUser, currentUser } = UserCurrentNetflixUser();
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <div className=" flex  gap-1  items-center">
                    <Image src={currentUser ? currentUser.avatarUrl : "/profiles/imagen1.png"} alt="Profile Image" width={35} height={35}
                    />
                    <ChevronDown />
